...
const HeaderLayout = () => {
  ...
  return (
    <Header style={headerStyle}>
      ...
      <HomeOutlined style={{ fontSize: "35px" }} />
      <div style={iconGroupStyle}>
        <BellOutlined style={{ fontSize: "35px", marginRight: "46px" }} onClick={handleBellIconClick} />
        <Dropdown overlay={avatarMenu} trigger={['click']}>
          <UserOutlined style={{ fontSize: "35px" }} />
        </Dropdown>
      </div>
      <Modal title="Notification" visible={isModalVisible} onCancel={handleModalCancel} footer={null}>
